...
description: Apply anti-slop frontend design guidance to TinyRoute marketing and landing pages or visual redesigns, always under DESIGN.md. Do not use for dashboards, analytics, data tables, routine product components, APIs, or backend behavior.
---

# tasteskill: Anti-Slop Frontend Skill

## TinyRoute project authority

This is a tailored snapshot of
[Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill/tree/ccbc15639c97057cbfcf32ecebc38ef716e4bb37/skills/taste-skill),
vendored at commit `ccbc15639c97057cbfcf32ecebc38ef716e4bb37` under the
[MIT license](../../../docs/licenses/taste-skill-MIT.txt).

For TinyRoute, this skill supplements the project contract and never overrides
it:

1. Before frontend work, read [DESIGN.md](../../../DESIGN.md). It is the
   authority for presentation, brand, accessibility, responsive behavior,
   components, states, density, and motion.
2. Read the matching
   [functional requirements](../../../docs/requirements/Functional.md),
   [non-functional requirements](../../../docs/requirements/Non-Functional.md),
   and [architecture](../../../docs/architecture/architecture.md). They govern
   behavior, security, ownership, validation, scope, APIs, and redirects.
3. Apply the guidance below only to TinyRoute marketing or landing pages and
   visual redesigns. Do not apply it implicitly to dashboards, analytics, data
   tables, routine product components, API work, or backend work.
4. Treat every package, design-system, animation, image-generation, font, icon,
   and external-tool mandate below as advisory in TinyRoute. Use it only when
   it is already present or the user or an approved feature spec expressly
   authorizes it. A `MUST`, `ALWAYS`, or similar upstream instruction is not
   authorization to add a dependency, generate an asset, or expand the task.
5. Preserve TinyRoute's established design system and locked Next.js client /
   Spring Boot backend boundary. If any rule below conflicts with the project
   contract or the user's request, follow the project contract and user.
